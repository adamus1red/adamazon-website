...
?>
            ...
            <h1 style="font-family: 'Raleway', sans-serif;">Who we are</h1>
            ...
            <hr>
            <h1 style="font-family: 'Raleway', sans-serif;">The Team</h1>
            <table>
                <tbody>
                    <tr style="padding: 10px;">
                        <td width="25%">
                            <h1 style="font-family: 'Raleway', sans-serif;">Adam McGhie</h1>
                            <p>Wrote the back-end and base CSS</p>
                        </td>
                        <td width="25%">
                            <h1 style="font-family: 'Raleway', sans-serif;">Thomas Sinclair</h1>
                            <p>Wrote some...</p>
                        </td>
                        <td width="25%">
                            <h1 style="font-family: 'Raleway', sans-serif;">Grant Toghill</h1>
                            <p>Wrote some CSS</p>
                        </td>
                        <td width="25%">
                            <h1 style="font-family: 'Comic Sans MS', cursive, sans-serif;">Darren Tang</h1>
            ...
            <hr>
            <h1 style="font-family: 'Raleway', sans-serif;">Contact Us</h1>
